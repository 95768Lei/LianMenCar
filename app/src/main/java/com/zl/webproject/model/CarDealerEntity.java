...
public class CarDealerEntity implements java.io.Serializable {
    ...
    private Integer dealerBrowse = 0;
    private Integer dealerForWard = 0;

    private String dealerRefreshDateStr;

    public Integer getDealerBrowse() {
        return dealerBrowse;
    }

    public void setDealerBrowse(Integer dealerBrowse) {
        this.dealerBrowse = dealerBrowse;
    }

    public Integer getDealerForWard() {
        return dealerForWard;
    }

    public void setDealerForWard(Integer dealerForWard) {
        this.dealerForWard = dealerForWard;
    }
